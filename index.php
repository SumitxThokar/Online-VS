		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
                ...
                <?php 
                    ...
                    {
                ?>
                        <span style="background-color: #303030;" class="text-success text-center "> Your account has been created successfully! </span>
                <?php
                ...
                ?>
                        <span style="background-color: #303030;" class="text-warning text-center "> Sorry, you are not registered! </span>
                <?php
